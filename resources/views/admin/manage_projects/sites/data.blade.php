        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="nav nav-tabs wizard-head" id="siteTabs">
                            <a class="nav-link active" href="#site-details" data-tab="site-details"
                               data-name="tab-site-details" data-bs-toggle="tab">
                                <span class="nav-contents">
                                    <i class="bi bi-1-square-fill active"></i>
                                    <span class="nav-title">Details</span>
                                </span>
                            </a>
                            <a class="nav-link" href="#site-contracts" data-tab="site-contracts"
                            data-name="tab-site-contracts" data-bs-toggle="tab">
                            <span class="nav-contents">
                                <i class="bi bi-2-square-fill"></i>
                                <span class="nav-title">Contracts</span>
                            </span>
                            </a>
                            <a class="nav-link" href="#site-stages" data-tab="site-stages"
                            data-name="tab-site-stages" data-bs-toggle="tab">
                                <span class="nav-contents">
                                    <i class="bi bi-3-square-fill"></i>
                                    <span class="nav-title">Stages</span>
                                </span>
                            </a>
                            <a class="nav-link" href="#site-documents" data-tab="site-documents"
                               data-name="tab-site-documents" data-bs-toggle="tab">
                                <span class="nav-contents">
                        ...
                        <form id="site-form"
                            ...
                            <div class="tab-content mt-3">
                                <!-- Site Details Tab -->
                                <div class="tab-pane fade show active" id="site-details">
                                    <div class="container-fluid p-0">
                                        <div class="row g-3">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label>Site No <span class="text-danger">*</span></label>
                                                    <input type="text" name="site_no" class="form-control" value="{{ old('site_no', $site->site_no ?? '') }}" required>
                                                    @error('site_no')
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="project_id" id="project_id" class="form-control select2" data-selected="{{ old('project_id', $site->project_id ?? '') }}" required></select>
                                                    @error('project_id')
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="engineer_id" id="engineer_id" class="form-control select2" data-selected="{{ old('engineer_id', $site->engineer_id ?? '') }}" required></select>
                                                    @error('engineer_id')
                                                    <span class="text-danger mt-1">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="type" class="form-control" value="{{ old('type', $site->type ?? '') }}" required>
                                                    @error('type')
                                                    <div class="err text-danger mt-1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="range" class="form-control" value="{{ old('range', $site->range ?? '') }}" required>
                                                    @error('range')
                                                    <div class="err text-danger mt-1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="area_sqft" class="form-control" value="{{ old('area_sqft', $site->area_sqft ?? '') }}" required>
                                                    @error('area_sqft')
                                                    <div class="err text-danger mt-1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control" id="status" required>
                                                        ...
                                                        @foreach(SITE_STATUSES as $status)
                                                            <option value="{{ $status }}" {{ $status == ($site ? old('status', $site->status) : old('status')) ? 'selected' : '' }}>{{ $status }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('status')
                                                    <div class="err text-danger mt-1">{{ $message }}</div>
                                            ...
                                            <div class="col-12 col-md-6 d-none" id="sold_amount_div">
                                                <div class="form-group">
                                                    <label>Sold Price <span class="text-danger">*</span></label>
                                                    <input type="number" id="sold_amount" class="form-control" value="{{ old('sold_amount', $site->sold_amount ?? '') }}">
                                                    @error('sold_amount')
                                                    <div class="err text-danger mt-1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="tab-pane fade" id="site-contracts">
                                    <div class="card">
                                    ...
                                    <table class="table table-hover {{ (is_object($site) && count($site->contracts) > 0) ? '' : 'd-none' }} mt-20 form-group">
                                    <thead>
                                            <tr>
                                                <th>S.No</th>
                                        ...
                                        <tbody id="tblContract">
                                            ...
                                            @endphp
                                            @if ($site)
                                                @foreach ($site->contracts as $contract)
                                                <tr data-new="false">
                                                    <td>{{$serialNum++}}</td>
                                ...
                                <div class="tab-pane fade" id="site-stages">
                                    <!-- Stages Management -->
                                    <div class="row col-12 mt-10 card form-group">
                                        <label>Site Stages</label>
                                        ...
                                        <ul id="stage-list" class="list-group mt-2 ml-10">
                                            @php
                                                $stages = old('stages', $site ? $site->stages()->withTrashed()->orderBy('order_no')->get()->toArray() : []);
                                            @endphp
                                ...
                                <!-- Site Documents Tab -->
                                <div class="tab-pane fade" id="site-documents">
                                    ...
                                    <table class="table table-responsive table-hover mb-30 d-none">
                                        ...
                                        <tbody id="tblSiteDocuments"></tbody>
                                    </table>
                                    ...
                                    <div class="row mt-40 text-end">
                                        ...
                                        <div class="col-6 text-end">
                                            <a class="btn btn-outline-light btn-prev">Previous</a>
                                            <a class="btn btn-primary" onclick="$('#site-form').submit()">Submit</a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- End Tab Content -->
        ...
        $(document).ready(function () {
            ...
            $('.multipleImageDocument').on('input', function (event) {
                ...
                if (title) {
                    ...
                    formData.append('module_name', "{{ ($site && $site->id) ? 'Site' : 'User-Site' }}");
                    formData.append('module_id', "{{ ($site && $site->id) ? $site?->id : Auth::id() }}");
            ...
            $('#btnSaveDocument').on('click', function () {
                ...
                $('#tblSiteDocuments').append(html).closest('table').removeClass('d-none');
                serialize('#tblSiteDocuments');
            ...
            $('#btnUpdateDocument').on('click', function () {
                ...
                if (title) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.success) {
                                $('#tblSiteDocuments').find(`tr[data-edit="${updatingRowId}"]`).each(function () {
                                    let row = $(this);
            ...
            $(document).on('click', '.deleteDocuments', function () {
                ...
                let flag = $('#tblSiteDocuments tr').length;

                if (!flag) $('#tblSiteDocuments').closest('table').addClass('d-none');
            ...
            let isEditMode = {{ $site ? 'true' : 'false' }};
            ...
            const getDocuments = () => {
                $.ajax({
                    ...
                    data: {
                        _token: "{{ csrf_token() }}",
                        module_name: "{{ ($site && $site->id) ? 'Site' : 'User-Site' }}",
                        module_id: "{{ ($site && $site->id) ? $site->id : Auth::id() }}"
                    },
                    success: function (response) {
